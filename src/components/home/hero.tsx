        ...
        <h1 className="text-4xl font-bold sm:text-5xl">
          <span
            dangerouslySetInnerHTML={{
              __html: m.homepage_heroText()
                .replace("<s>", '<span class="whitespace-nowrap text-primary-500">')
                .replace("</s>", "</span>"),
            }}
          />
        </h1>
        <div className="mb-12 text-xl text-gray-400">{m.homepage_heroSubText()}</div>
